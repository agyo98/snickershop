      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-secondary/50 border border-border mb-8 animate-fade-up">
            ...
            <span className="text-sm text-muted-foreground">Premium Sneaker Marketplace</span>
          </div>
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-foreground mb-6 animate-fade-up" style={{ animationDelay: '0.1s' }}>
            YOUR NEXT
            <span className="block text-gradient">GRAIL AWAITS</span>
          </h1>
          ...
          <div className="grid grid-cols-3 gap-8 mt-16 pt-16 border-t border-border/50 animate-fade-up" style={{ animationDelay: '0.4s' }}>
            <div className="text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">상품</p>
            </div>
            <div className="text-center">
              <p className="font-display text-3xl md:text-4xl text-foreground">50K+</p>
              <p className="text-sm text-muted-foreground mt-1">회원</p>
            </div>
            <div className="text-center">
              <p className="font-display text-3xl md:text-4xl text-foreground">100%</p>
              <p className="text-sm text-muted-foreground mt-1">정품 보장</p>
            </div>
          </div>
        </div>
      </div>
