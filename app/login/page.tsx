    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="flex-1 flex flex-col justify-center px-8 md:px-16 lg:px-24">
        <div className="max-w-md w-full mx-auto">
          ...
          {/* Form Header */}
          <div className="mb-8">
            <h1 className="font-bold text-4xl text-gray-900 mb-2">로그인</h1>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button className="border border-gray-300 text-gray-700 hover:bg-gray-50 px-6 py-3 rounded-lg font-medium flex items-center justify-center gap-2">
      ...
      <div className="hidden lg:flex flex-1 relative bg-gray-100 overflow-hidden">
        ...
        <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-blue-500/30 rounded-full blur-[128px]" />
        <div className="absolute bottom-1/3 right-1/3 w-64 h-64 bg-blue-500/20 rounded-full blur-[96px]" />
        ...
        <div className="relative z-10 flex flex-col justify-center items-center w-full p-16">
          <h2 className="font-bold text-6xl text-white text-center mb-4">
            STEP INTO
            <span className="block bg-gradient-to-r from-blue-400 to-purple-400 bg-clip-text text-transparent">STYLE</span>
          </h2>
          <p className="text-gray-300 text-center max-w-md">
            프리미엄 스니커즈의 세계에 오신 것을 환영합니다.
            한정판부터 클래식까지, 당신의 스타일을 완성하세요.
          </p>
        </div>
      </div>
    </div>
